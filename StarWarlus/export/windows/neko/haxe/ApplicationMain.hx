...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "StarWarlus", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "StarWarlus";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "StarWarlus", null, { width: 960, height: 640 });
