...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		Font.registerFont (__ASSET__assets_fonts_bebasneue_otf);
...
@:keep class __ASSET__assets_fonts_bebasneue_otf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/fonts/BebasNeue.otf"; fontName = "Bebas Neue"; }}


#else


class __ASSET__assets_fonts_bebasneue_otf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/fonts/BebasNeue.otf"; fontName = "Bebas Neue";  }}
...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		openfl.text.Font.registerFont (__ASSET__OPENFL__assets_fonts_bebasneue_otf);
		...
		type.set ("assets/fonts/BebasNeue.otf", AssetType.FONT);
		...
		className.set ("assets/fonts/BebasNeue.otf", __ASSET__assets_fonts_bebasneue_otf);
		type.set ("assets/fonts/BebasNeue.otf", AssetType.FONT);
		useManifest = true;
		useManifest = true;
		useManifest = true;
...
@:keep #if display private #end class __ASSET__assets_fonts_bebasneue_otf extends lime.text.Font { public function new () { super (); name = "Bebas Neue"; } } 
...
@:keep #if display private #end class __ASSET__assets_fonts_bebasneue_otf extends lime.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/fonts/BebasNeue.otf"; name = "Bebas Neue"; super (); }}
...
#if (openfl && !flash)
@:keep #if display private #end class __ASSET__OPENFL__assets_fonts_bebasneue_otf extends openfl.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/fonts/BebasNeue.otf"; name = "Bebas Neue"; super (); }}
